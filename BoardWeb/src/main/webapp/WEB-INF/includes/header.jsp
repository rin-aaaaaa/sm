	...
	<div class="d-flex" id="wrapper">
		...
		<div class="border-end bg-white" id="sidebar-wrapper">
			...
			<c:when test="${empty logid }">
				<div class="sidebar-heading border-bottom bg-light">지구멸망기원1일차(guest)</div>
					</c:when>
					<c:otherwise>
				<div class="sidebar-heading border-bottom bg-light">지구멸망기원1일차(${logid })</div>
					</c:otherwise>
			</c:choose>
		...
		<div id="page-content-wrapper">
			...
			<nav
				...
				<div class="container-fluid">
					<button class="btn btn-primary" id="sidebarToggle">토글토글</button>
